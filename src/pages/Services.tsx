...
function Services() {
  ...
  return (
    <ServicesLayout>
        ...
        <div className="relative bg-gray-900 text-white">
          ...
          <div className="relative max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
            <div className="text-center">
              ...
              <p className="font-normal text- max-w-3xl mx-auto  leading-9">
      ...
      <div className="container mb-10 mt-10 mx-auto grid grid-cols-1 md:grid-cols-3 gap-4 w-full px-10 py-10">
        {
          servicesArr?.map((item) => {
            return (
              <>
                <Link to={`/services_Details`}>
                  <ServiceCard description={item.des} title={item.title} key={item.id} icon={item.image} style={true} />
                </Link>
              </>
            )
          })
